...
#
# Python file name: Code_Challenge_File_IO.py
#
# Date: 9/24/23
#
# Programmer's name: Taylor Nii
...
#       function when you are processing your input file and output the species before outputting the group of
#       substrings that represent an individual animal.


# Define the input and output file paths
input_file_path = "/Users/taylornii/PycharmProjects/CIT95CodeChallenges/arrivingAnimals.txt"
# Use r (raw) before the path string to tell Python to not use the backslash as an escape character
output_file_path = r"/Users/taylornii/PycharmProjects/CIT95CodeChallenges/outputFile.txt"
...
try:
    with open(input_file_path, 'r') as input_file:
        ...
        print(f"data type of lines: {type(lines)}")
        ...
        print("The fourth list element is: " + lines[3])
        ...
        with open(output_file_path, "w") as output_file:
            for line in lines:
                ...
                #   left and think about what is happening. Communicate with someone on our Discord server and ask
                #   a question about this.
                print("***************".join(substrings))
                #
                #
                # unique id first 2 char of species, how many of
                # how many animals of type of species
                #
